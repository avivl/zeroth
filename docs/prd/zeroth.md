...
| [ADR-Z-0010](../adr/Z-0010-harness-host-subprocess.md) | Stage-1 Claude Code harness is a host subprocess against the overlay, not `sandbox.Exec` | Accepted |
| [ADR-Z-0011](../adr/Z-0011-independent-cross-exam-vendor.md) | Stage-1 cross-examiner is a different vendor than the producer | Accepted |
