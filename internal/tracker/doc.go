...
// human decision stated on the issue is in the next run's context.
// Unassign is also the cleanup half of retract: after a bad PR is closed,
// the agent is removed so a later assignment can start a fresh run
// (Linear 42-56).
